...
@section('content')
    ...
    <div class="container pt-4">
        <h2 class="textCenter font-white">聯絡我們</h2>
        <div class="row">
            <div class="pl-md-0 pr-md-2 col-12 col-md-6 order-md-first order-sm-last">
                <form autocomplete="off" action="{{ route('AddContact') }}" method="POST">
                    @csrf
                    <input type="text" class="form-control border-top-0 border-right-0 border-left-0 font-white bg-grey" name="user" placeholder="使用者名稱">
                    <input type="email" class="form-control mt-3 border-top-0 border-right-0 border-left-0 font-white bg-grey" name="email" placeholder="信箱">
                    <input type="text" class="form-control mt-3 border-top-0 border-right-0 border-left-0 font-white bg-grey" name="title" placeholder="標題">
                    <textarea rows="5" class="form-control mt-3 border-top-0 border-right-0 border-left-0 font-white bg-grey" name="content" placeholder="內容"></textarea>
                    <button type="button" class="btn btn-orange btn-lg btn-block mt-3">送出</button>
                </form>
            </div>

            <div class="mb-sm-4 mb-md-0 pl-md-2 pr-md-0 col-12 col-md-6 order-md-last order-sm-first">
    ...
    <div class="bg-grey">
        <div class="container mt-4 pt-4 py-4">
            ...
            <div class="row">
                ...
                <div class="col-3 col-md-3 col-sm-12  mt-sm-3 mt-md-0 pr-md-0 pl-md-2">
                    <button type="button" class="btn btn-orange btn-block">送出</button>
                </div>
