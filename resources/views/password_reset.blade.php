    ...
    <div class="container antiFlow">
        <div class="row d-flex align-items-center onePageHeight">
            ...
            <div class="col-12 col-md-6 col-xl-5 font-white onePageHeightAndCenterVertically antiFlow">
                <h1 class="p-3">修改密碼</h1>
                <form action="{{route("Password.Reset")}}" method="post">
                    @csrf
                    <div class="form-group">
                        <input type="password" class="form-control border-top-0 border-right-0 border-left-0 font-white bg-grey" name="old_password" placeholder="舊密碼">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control border-top-0 border-right-0 border-left-0 font-white bg-grey" name="new_password" placeholder="新密碼">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control border-top-0 border-right-0 border-left-0 font-white bg-grey" name="confirm_password" placeholder="確認密碼">
                    </div>
                    @if (session('message'))
